...
import 'package:flutter_github_test/widgets/entry_item.dart';
import 'package:flutter_github_test/widgets/markdown_view.dart';
import 'package:flutter_github_test/widgets/label.dart';
import 'package:flutter_github_test/widgets/language_bar.dart';
import 'package:flutter_github_test/widgets/mutation_button.dart';
import 'package:flutter_github_test/widgets/repo_header.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshStatefulScaffold<
      ...
      fetch: () async {
        ...
        final ghClient = context.read<LoginModel>().ghClient!;
                ...
                Row(
                  children: <Widget>[
                    ...
                    MutationButton(
                      ...
                      onTap: () async {
                        final activityApi =
                            context.read<LoginModel>().ghClient!.activity;
